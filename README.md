...
**تنبيه قانوني:** التداول في العملات المشفرة ينطوي على مخاطر عالية. استخدم هذا البوت على مسؤوليتك الخاصة. المطورون غير مسؤولين عن أي خسائر مالية.
...
<div align="center">
  <strong>Ellen Trading Bot</strong> - تداول ذكي وآمن 🚀
</div>
...
2. **استخدم VITE_DRY_RUN=true دائماً أثناء التطوير**
3. **غيّر VITE_FRONTEND_TOKEN في الإنتاج**
4. **استخدم Testnet قبل Live API**
5. **فعّل المصادقة الثنائية على حساب Binance**
6. **ابدأ بمبالغ صغيرة في التداول الحقيقي**
7. **راقب السجلات بانتظام**
8. **ضع حدود يومية للخسائر**
9. **احتفظ بنسخة احتياطية من مفاتيح API**
10. **اختبر جميع الاستراتيجيات في Paper Trading أولاً**
## الدعم والمساعدة
